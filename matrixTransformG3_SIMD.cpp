...
void	matrixTransformG3_SIMD(int* matrix, int* matrixNew, int L, int Q)
{
    ...
    {					
        ...
        {	
            ...
            * _mm_setzero_si128 
            * pxor xmm, xmm
            * https://software.intel.com/sites/landingpage/IntrinsicsGuide/#techs=MMX,SSE,SSE2,SSE3,SSSE3&expand=291,291,300,300,5022&text=_mm_setzero
            */
            ...
            */
            ...
            //x3 = _mm_shuffle_epi32(x3, 0x0231);
            ...
            // x4       = 00000,x1[2],x1[1],00000
            // from_x2  = 00000,00000,00000,x2[1]
            // from_x0  = x0[2],00000,00000,00000
            ...
            */
            ...
            // x5 = x2[3],x2[2],00000,00000
            // from_x0 = 00000,00000,00000,x0[3]
            // from_x1 = 00000,00000,x1[3],00000
